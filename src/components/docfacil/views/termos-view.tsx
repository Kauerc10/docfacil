...
/**
 * TermosView — Termos de Uso do DocFacil.
 * Versão 1.0, 13 de julho de 2026.
 *
 * 14 seções numeradas cobrindo: aceitação, descrição do serviço
 * (NÃO substitui advogado), limitação de responsabilidade
 * (teto = últimos 30 dias pagos), validade jurídica, obrigações do
 * usuário, contas, pagamentos (avulso R$9,90 / pro R$24,90,
 * reembolso CDC 7 dias), propriedade intelectual, privacidade,
 * suspensão, alterações, arbitragem (Câmara SP, Lei 9.307/96),
 * foro SP, disposições finais.
 *
 * Os links internos (Privacidade, Cookies) chamam navigate() para
 * manter a navegação SPA dentro do NavProvider.
 */
  ...
  return (
    ...
    >
      ...
      <p>
        ...
        Manemos um registro de concordância (com prova de tempo, IP e
      ...
      <p>
        Em qualquer hipótese, a responsabilidade agregada da{" "}
        {COMPANY.name} em relação a qualquer reclamação ficará limitada ao{" "}
        <strong>
      ...
      <ul>
        <li>
          <strong>Documento Avulso</strong> — R$ 9,90 por documento, sem
          necessidade de conta. Inclui PDF sem marca d&apos;água e download
          imediato.
        </li>
        <li>
          <strong>Plano Pro (mensal)</strong> — R$ 24,90/mês, com documentos
          ilimitados, edição, histórico salvo e prioridade no atendimento.
          Renovação automática; cancele quando quiser, sem fidelidade.
        </li>
      </ul>
      <p>
      ...
      <p>
        <strong>Reembolso (Direito de Arrependimento — CDC, art. 49):</strong>{" "}
        você pode solicitar o reembolso integral em até <strong>7 (sete)</strong>{" "}
        dias corridos contados da contratação ou do recebimento do produto,
        sem necessidade de justificativa. Para solicitar, envie um e-mail
        para{" "}
