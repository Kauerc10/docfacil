...
/**
 * PrivacidadeView — Política de Privacidade (LGPD).
 * Versão 1.0.
 *
 * 13 seções: introdução, dados coletados, base legal (art. 7º),
 * finalidades, compartilhamento, direitos do titular (art. 18º,
 * 10 direitos), cookies, segurança, retenção, transferência
 * internacional, DPO, alterações, contato.
 *
 * Links internos (Termos, Cookies) chamam navigate() para manter a
 * navegação SPA dentro do NavProvider.
 */
  ...
  return (
    ...
    >
      <p>
        ...
        em conformidade com a <strong>Lei Geral de Proteção de Dados
        (LGPD — Lei nº 13.709/2018)</strong>. Ao utilizar a plataforma,
        você concorda com o tratamento descrito aqui.
      </p>

      <h2>1. Introdução</h2>
      <p>
        O <strong>controlador</strong> dos dados é a {COMPANY.name}, com
        sede em São Paulo/SP, responsável por decidir o que é coletado e
        como é usado. Você pode entrar em contato a qualquer momento pelo{" "}
        <a href={`mailto:${COMPANY.email}`}>{COMPANY.email}</a> ou pelo
        DPO indicado na seção 12.
      </p>
      ...
      <ul>
        <li>
          <strong>De identificação:</strong> nome completo, e-mail, foto
          (se login via Google).
        </li>
        <li>
          <strong>De contato:</strong> telefone (opcional, se você
          informar no perfil).
        </li>
        <li>
        ...
        <li>
          <strong>De pagamento:</strong> dados de cobrança processados
          pelos gateways (não armazenamos número de cartão).
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          ...
          entregar os documentos solicitados, processar pagamentos e
        ...
        <li>
          ...
          serviço — sempre balanceado com seus direitos.
        </li>
      </ul>
      ...
      <ul>
        <li>
          ...
          — apenas dados necessários à cobrança, sob contratos de
          processador.
        </li>
        <li>
      ...
      <ul>
        ...
        <li>Revisão de decisões automatizadas (não usamos decisão exclusivamente automatizada com efeito relevante);</li>
        <li>Oposição ao tratamento, nos casos permitidos.</li>
      </ul>
      <p>
        Para exercer qualquer direito, escreva para{" "}
        <a href={`mailto:${COMPANY.email}`}>{COMPANY.email}</a> com o
        assunto &quot;LGPD — solicitação&quot;. Respondemos em até 15 (quinze)
        dias corridos.
      </p>
      ...
      <p>
        ...
        lembrar preferências e, com seu consentimento, medir uso. Os
        detalhes estão na{" "}
        <button
          type="button"
      ...
      <p>
        ...
        proteger seus dados: criptografia em trânsito (TLS), criptografia
        em repouso, controle de acesso baseado em função, registro de
        logs administrativos e monitoramento. Nenhum sistema é 100%
        seguro; em caso de incidente que possa causar risco ou dano
        relevante, comunicaremos você e a ANPD nos termos do art. 48 da
        LGPD.
      </p>
      ...
      <ul>
        ...
        <li>
          <strong>Após o prazo:</strong> anonimizados (sem possibilidade
          de reidentificação) ou eliminados.
        </li>
      </ul>
      ...
      <ul>
        <li>
          E-mail:{" "}
          <a href={`mailto:${COMPANY.email}`}>{COMPANY.email}</a> (assunto:
          &quot;DPO&quot;)
        </li>
        <li>
      ...
      <p>
        ...
        comunicadas pelo e-mail cadastrado ou por banner na plataforma,
        com antecedência mínima de 15 (quinze) dias. A versão vigente
        é sempre a publicada nesta página, com data no cabeçalho.
      </p>
      ...
      <p>
        ...
        . Estamos em São Paulo/SP, {COMPANY.productName} — {COMPANY.name}.
      </p>
    </LegalLayout>
  );
}
