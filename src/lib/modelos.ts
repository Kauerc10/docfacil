  ...
  // ==========================================================================
  {
    ...
    template: {
      ...
      corpo: [
        ...
        "LOCADOR: {{locador_nome}}, {{locador_nacionalidade}}, {{locador_estado_civil}}, {{locador_profissao}}{{locador_rg_separador}} e inscrito(a) no CPF sob o nº {{locador_cpf}}, doravante denominado simplesmente LOCADOR;",
        "e, de outro lado:",
        "LOCATÁRIO: {{locatario_nome}}, {{locatario_nacionalidade}}, {{locatario_estado_civil}}, {{locatario_profissao}}{{locatario_rg_separador}} e inscrito(a) no CPF sob o nº {{locatario_cpf}}, o(a) qual passará a residir no imóvel objeto deste contrato a partir da data de sua assinatura, doravante denominado(a) simplesmente LOCATÁRIO;",
        ...
        "O valor mensal do aluguel é de R$ {{valor}}{{valor_extenso}}, a ser pago até o dia {{dia_vencimento}} de cada mês, mediante {{forma_pagamento}} na conta de titularidade do LOCADOR, ou outro meio expressamente indicado por escrito.",
