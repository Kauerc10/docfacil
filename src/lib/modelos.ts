  ...
  // ==========================================================================
  {
    ...
    template: {
      ...
      corpo: [
        ...
        "e, de outro lado:",
        "LOCATÁRIO(A): {{locatario_nome}}, {{locatario_nacionalidade}}, {{locatario_estado_civil}}, {{locatario_profissao}}{{locatario_rg_separador}} e inscrito(a) no CPF sob o nº {{locatario_cpf}}, residente e domiciliado(a) na {{imovel}}, doravante denominado(a) simplesmente LOCATÁRIO;",
