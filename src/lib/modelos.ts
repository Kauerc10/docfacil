...
const MODELS_INPUT: Omit<Modelo, "campos">[] = [
  ...
  // ==========================================================================
  {
    ...
    etapas: [
      ...
      },
      {
        tipo: "campo",
        campo: {
          key: "moradores_autorizados",
          pergunta: "Vai morar mais alguém no imóvel?",
          tipo: "lista_pessoas",
          obrigatorio: false,
          microcopy: "Você pode informar quem vai morar com o inquilino. Essas pessoas não passam a ser responsáveis pelo contrato.",
          listaPessoas: {
            itemLabel: "morador",
            maxItens: 4,
          },
    ...
    template: {
      ...
      corpo: [
        ...
        "",
        "## CLÁUSULA OITAVA – DA MANUTENÇÃO E CONSERVAÇÃO",
        ...
        "",
        "## CLÁUSULA NONA – DA RESCISÃO, DA INFRAÇÃO E DA MULTA",
  ...
  // ==========================================================================
  {
    ...
    etapas: [
      ...
      },
      {
        ...
        campos: [
          ...
          {
            key: "vistoria_anexa",
            pergunta: "As partes vão juntar termo de vistoria e registro fotográfico apartados?",
            tipo: "select",
            opcoes: ["Sim", "Não"],
            obrigatorio: false,
            microcopy: "A plataforma não recebe arquivos; os documentos são preparados, assinados e juntados pelas partes.",
          },
        ],
      },
      {
        ...
        clausulas: [
          {
            ...
            titulo: "Caução em dinheiro",
            descricao: "Locatário deposita até 3 meses de aluguel como garantia.",
            corpo: "Como garantia das obrigações assumidas, as partes optam pela modalidade CAUÇÃO EM DINHEIRO, nos termos do art. 37 da Lei nº 8.245/1991. O LOCATÁRIO deposita neste ato, em caderneta de poupança, a título de caução, a importância de R$ {{caucao_valor}}, equivalente a {{caucao_meses}} mês(es) de aluguel; os rendimentos reverterão ao LOCATÁRIO ao final da locação, observadas as compensações legalmente cabíveis. A garantia vigorará durante a locação e eventual prorrogação até a efetiva desocupação e quitação das obrigações contratuais.",
            camposExtras: [
          ...
          },
          {
            ...
            corpo: "Como garantia das obrigações assumidas, as partes optam pela modalidade FIANÇA, nos termos do art. 37 da Lei nº 8.245/1991. Assina também este contrato, como FIADOR(A) e principal pagador(a), solidariamente responsável com o LOCATÁRIO, o(a) Sr.(a) {{fiador_nome}}, portador(a) do CPF nº {{fiador_cpf}}. A garantia vigorará durante a locação e eventual prorrogação até a efetiva desocupação e quitação das obrigações contratuais.",
            camposExtras: [
    ...
    template: {
      ...
      corpo: [
        ...
        "LOCADOR(A): {{locador_nome}}, {{locador_nacionalidade}}, {{locador_estado_civil}}, {{locador_profissao}}{{locador_rg_separador}} e inscrito(a) no CPF sob o nº {{locador_cpf}}, doravante denominado(a) simplesmente LOCADOR;",
        "e, de outro lado:",
        "LOCATÁRIO(A): {{locatario_nome}}, {{locatario_nacionalidade}}, {{locatario_estado_civil}}, {{locatario_profissao}}{{locatario_rg_separador}} e inscrito(a) no CPF sob o nº {{locatario_cpf}}, domiciliado(a) na {{imovel}}, doravante denominado(a) simplesmente LOCATÁRIO;",
        ...
        "{{vistoria_comercial}}",
        "Cabe ao LOCATÁRIO obter, às suas expensas, todas as licenças, alvarás e autorizações necessárias ao exercício de sua atividade, incluindo alvará de funcionamento, licença sanitária e/ou ambiental, quando exigíveis.",
        "",
        "## CLÁUSULA SEGUNDA – DO PRAZO",
        ...
        "A vigência deste contrato perante eventual adquirente depende dos requisitos legais aplicáveis, inclusive prazo determinado, cláusula de vigência em caso de alienação e averbação na matrícula quando cabível, nos termos do art. 8º da Lei nº 8.245/1991.",
  ...
  // ==========================================================================
  {
    ...
    etapas: [
      ...
      {
        tipo: "campo_grupo",
        tituloGrupo: "Identificação registral do imóvel",
        campos: [
          {
            key: "matricula_imovel",
            pergunta: "Número da matrícula do imóvel:",
            placeholder: "Ex: 12.345",
          },
          {
            key: "registro_imoveis",
            pergunta: "Registro de Imóveis competente:",
            placeholder: "Ex: 1º Registro de Imóveis de Blumenau/SC",
          },
          {
            key: "descricao_registral",
            pergunta: "Descrição complementar constante do registro:",
            placeholder: "Ex: Apartamento 302, com área privativa de 80 m²",
            tipo: "textarea",
          },
        ],
      },
      {
        ...
        campos: [
          ...
          {
            key: "possui_sinal",
            pergunta: "Há sinal/arras nesta contratação?",
            tipo: "select",
            opcoes: ["Sim", "Não"],
          },
          {
    ...
    template: {
      ...
      corpo: [
        ...
        "",
        "## CLÁUSULA PRIMEIRA – DO OBJETO",
        "O VENDEDOR é legítimo e único proprietário do imóvel situado na {{imovel}}, matriculado sob o nº {{matricula_imovel}} perante o {{registro_imoveis}}, com a seguinte descrição complementar: {{descricao_registral}}, doravante denominado simplesmente IMÓVEL.",
        ...
        "{{clausula:arras}}",
        "O preço será pago da seguinte forma: {{saldo_pagamento}}.",
        ...
        "",
        "## CLÁUSULA TERCEIRA – DA POSSE E DA TRADIÇÃO",
        ...
        "",
        "## CLÁUSULA QUARTA – DA SITUAÇÃO JURÍDICA DO IMÓVEL",
        ...
        "",
        "## CLÁUSULA QUINTA – DA ESCRITURA PÚBLICA E DO REGISTRO",
        ...
        "",
        "## CLÁUSULA SEXTA – DOS TRIBUTOS E DESPESAS DA TRANSAÇÃO",
  ...
  // ==========================================================================
  {
    ...
    etapas: [
      ...
      },
      {
        ...
        campos: [
          ...
          {
            key: "periodo_emprestimo",
            pergunta: "Informe o prazo por extenso do empréstimo:",
            placeholder: "Ex: seis meses",
            microcopy: "Escreva o prazo por extenso, sem ocultar a unidade de tempo.",
          },
        ],
      },
      {
        ...
        clausulas: [
          {
            ...
            corpo: "O COMODATÁRIO responde pelos danos que lhe forem imputáveis, inclusive os decorrentes de uso em desacordo com este contrato, culpa, negligência ou imperícia, devendo reparar o prejuízo comprovado. Esta cláusula não o torna segurador do bem nem presume responsabilidade por furto ou roubo sem fato que lhe seja imputável.",
          },
          {
            id: "uso",
    ...
    template: {
      ...
      corpo: [
        ...
        "O prazo de vigência deste comodato é de {{periodo_emprestimo}}, contados a partir da data de assinatura deste instrumento.",
        "Ao término do prazo ajustado, o COMODATÁRIO obriga-se a restituir o bem ao COMODANTE em adequado estado de conservação, ressalvado o desgaste natural decorrente do uso regular, sob pena de responder pelos danos que lhe forem imputáveis e constituir-se em mora, nos termos do art. 582 do Código Civil.",
        "",
  ...
  // ==========================================================================
  {
    ...
    etapas: [
      ...
      {
        tipo: "campo_grupo",
        tituloGrupo: "Local de assinatura",
        campos: [
          {
            key: "vendedor_cidade",
      ...
      },
      {
        ...
        campo: {
          ...
          tipo: "textarea",
          microcopy: "Descreva com o máximo de detalhes possível (marca, modelo, série, ano). Para veículos, informe os dados próprios; este modelo genérico não substitui os atos de transferência veicular.",
        },
      },
      {
        tipo: "campo_grupo",
    ...
    template: {
      ...
      corpo: [
        ...
        "{{vendedor_cidade}}/{{vendedor_uf}}, [data de assinatura].",
        "",
        "[ASSINATURA] _______________________________________________",
